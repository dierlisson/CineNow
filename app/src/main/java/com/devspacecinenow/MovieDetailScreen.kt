...
private fun MovieDetailPreview(){
    CineNowTheme {
        val movie = MovieDto(
            ...
            title="Sample Movie",
            postPath="asdasdad",
            overview="This is a sample movie used for previewing the MovieDetailScreen composable in Jetpack Compose."+
                    "This is a sample movie used for previewing the MovieDetailScreen composable in Jetpack Compose."+
                    "This is a sample movie used for previewing the MovieDetailScreen composable in Jetpack Compose.",
        )
